...
- [JGrowing:Java成长路线，但学到不仅仅是Java](https://github.com/javagrowing/JGrowing)
- [Waking-Up:全部采用【问题+追问+答案】的形式，即拿即用，直击互联网大厂面试](https://github.com/wolverinn/Waking-Up)
- [interview:Java笔试面试知识整理](https://github.com/hadyang/interview)
...
- [interviewGuide:《大厂面试指北》——后端面试题精选](https://github.com/NotFound9/interviewGuide)
- [JavaInterview:Java面试+Java后端技术学习指南](https://github.com/OUYANGSIHAI/JavaInterview)
- [Java-Summarize:Java核心知识点整理](https://github.com/zaiyunduan123/Java-Summarize)
- [JavaInterview:Java面试整理](https://github.com/gsjqwyl/JavaInterview)
- [CodeGuide:本代码库是作者小傅哥多年从事一线互联网Java开发的学习历程技术汇总](https://github.com/fuzhengwei/CodeGuide)
- [bestJavaer:这是一个成为更好的Java程序员的系列教程](https://github.com/crisxuan/bestJavaer)
- [CookBook:JAVA高级架构师技术栈](https://github.com/Byron4j/CookBook)
- [Full-Stack-Notes:全栈工程师手册](https://github.com/heibaiying/Full-Stack-Notes)
- [notes:CS必备基础知识](https://github.com/tanglei302wqy/notes)
- [MoreThanJava:学习,不止Code](https://github.com/wmyskxz/MoreThanJava)
- [JavaKeeper:Java工程师必备架构体系知识总结](https://github.com/Jstarfish/JavaKeeper)
- [interview-notes:Java面试基础总结和学习笔记，包括大数据、linux、数据库等核心技术点](https://github.com/loulanyue/interview-notes)
- [algo-basic:专注于分享算法，计算机基础](https://github.com/iamshuaidi/algo-basic)
- [Java-Notes:关于Java面试题、笔记的分享](https://github.com/ZingBug/Java-Notes)
- [primary-java:java基础知识](https://github.com/czz1233/primary-java)
- [note-of-interview:《互联网面试笔记》收集和分析互联网常见面试题](https://github.com/zhengjianglong915/note-of-interview)
